...
const TechnologyDetail = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main = {
  components: {
    TechnologyDetail,
  ...
  setup() {
    ...
    const technology = computed(() => {
      ...
      return pageData.value.technologies ? pageData.value.technologies.find((item) => item.id == id) : null;
    });
    return {
      technology
    };
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_TechnologyDetail = resolveComponent("TechnologyDetail");
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_PageHeader, { title: "Technology Details" }, null, _parent));
  _push(ssrRenderComponent(_component_TechnologyDetail, { singleTechnology: $setup.technology }, null, _parent));
  _push(`</div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/technology-details/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { _id_ as default };
//# sourceMappingURL=_id_-CrR0UPf-.mjs.map
