...
import { useSSRContext, computed, resolveComponent, mergeProps, withCtx, createTextVNode, toDisplayString } from 'vue';
...
const _sfc_main = {
  ...
  setup() {
    ...
    const service = computed(() => {
      ...
      return pageData.value.features ? pageData.value.features.find((item) => item.id == id) : null;
    });
    return {
      service
    };
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_PageHeader, { title: "Service Details" }, null, _parent));
  if ($setup.service) {
    _push(ssrRenderComponent(_component_ServiceDetail, { service: $setup.service }, null, _parent));
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/service-detail/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { _id_ as default };
//# sourceMappingURL=_id_-4snT6c9O.mjs.map
